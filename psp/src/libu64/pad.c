/* Ported unmodified from reference/oot/src/libu64/pad.c (pure input-state
 * logic, no N64-hardware dependency), except bzero -> memset since PSPSDK's
 * newlib doesn't reliably expose bzero without extra defines. */
